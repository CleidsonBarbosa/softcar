...
from database.funcionarios_dao import listar_todos
...
class App(ctk.CTk):
    def __init__(self):
        ...
        try:
            dados_funcionarios = listar_todos()
...
# ANTES (remova os dados_funcionarios):
dados_ficticios = [...]

# DEPOIS (dentro do __init__, após criar o grid_container):
